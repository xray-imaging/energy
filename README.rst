...
To list of all available options::
    ...
    Commands:
        ...
        mono         Usage: dmm mono --energy 20 - Set the beamline to the --energy value using a precalibrated list or, if missing, a linear interpolation between the two closest
                     calibrared values
